...
void recur2(int i0, int i1,int j0, int j1, int k0, int k1,float **C, float **A, float **B)
    {
        int i, j, k, di = i1 - i0, dj = j1 - j0, dk = k1 - k0;
        if (di >= dj && di >= dk && di > CUTOFF2) {
            int im = (i0 + i1) / 2;
            recur2(i0,im,j0,j1,k0,k1, C,A,B);
            recur2(im,i1,j0,j1,k0,k1,C,A,B);
        } else if (dj >= dk && dj > CUTOFF2) {
            int jm = (j0 + j1) / 2;
            recur2(i0,i1,j0,jm,k0,k1,C,A,B);
            recur2(i0,i1,jm,j1,k0,k1,C,A,B);
        } else if (dk > CUTOFF2) {
            int km = (k0 + k1) / 2;
            recur2(i0,i1,j0,j1,k0,km,C,A,B);
            recur2(i0,i1,j0,j1,km,k1,C,A,B);
        } else {
		recur(i0, i1, j0, j1, k0, k1, C, A, B);
    }
